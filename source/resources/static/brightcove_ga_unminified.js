...
(function() {
	...
	videojs.plugin("ga", function(options) {
		...
		if (tracker) {
			...
			ga("create", tracker, {"name": "2627ed8a59a02e1d9cd65652cb633058"});
			ga("2627ed8a59a02e1d9cd65652cb633058.require", "displayfeatures");
		}
		...
		sendbeacon = function(action, nonInteraction, value) {
			if (sendbeaconOverride) {
				...
				ga("2627ed8a59a02e1d9cd65652cb633058.send", "event", {
